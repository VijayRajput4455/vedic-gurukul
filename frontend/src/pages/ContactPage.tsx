    ...
    <div className="contact-page-wrapper">
      ...
      <section className="section-pad" style={{ backgroundColor: 'var(--color-bg-main)' }}>
        <div className="container">
          ...
          <div className="grid-2" style={{ gap: 'var(--spacing-8)', alignItems: 'stretch' }}>
            
            {/* Left: Official Contact Details & Visiting Guidelines */}
            <div className="vedic-card-ornate" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
              <div>
              ...
              <div style={{
                ...
                <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', fontSize: 'var(--text-xs)', color: 'var(--color-text-secondary)', margin: 0, paddingLeft: '1.1rem' }}>
              ...
              <div>
                <div className="section-tag" style={{ marginBottom: '0.75rem' }}>
                  <span className="vedic-badge badge-saffron">
                    {language === 'hi' ? 'ऑनलाइन सन्देश' : 'Inquiry Portal'}
                  </span>
                </div>
                <h3 style={{
                  fontFamily: 'var(--font-heading-devanagari)',
