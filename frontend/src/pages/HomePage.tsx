...
export const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="homepage-wrapper">
      ...
      {/* 3. Educational Philosophy & Dayanand Saraswati Principles */}
      <PhilosophyTeaser onNavigate={onNavigate} />

      {/* 4. Academic Programs Highlights */}
      <ProgramsTeaser onNavigate={onNavigate} />

      {/* 5. Vedic Gurukul Trust & Seva Preview */}
      <TrustPreview onNavigate={onNavigate} />

      {/* 6. Daily Shloka of the Day & Audio Resonator */}
      <DailyVedicVichar />

      {/* 7. Virtual Tour & Campus Callout Banner */}
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 5, textAlign: 'center', maxWidth: '820px' }}>
          ...
          <div style={{
            ...
            <span>{language === 'hi' ? 'वैदिक गुरुकुल ट्रस्ट द्वारा समर्थित • पारदर्शी एवं प्रामाणिक शिक्षण' : 'Supported by Vedic Gurukul Trust • Authentic & Transparent Education'}</span>
          </div>
